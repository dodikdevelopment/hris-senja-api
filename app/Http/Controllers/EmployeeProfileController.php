...
class EmployeeProfileController extends Controller implements HasMiddleware
{
    ...
    public static function middleware()
    {
        return [
            ...
            new Middleware(PermissionMiddleware::using(['profile-view']), only: ['getMyProfile']),
            // Statistik performa dipakai dari dua arah: halaman detail employee
            // (admin/HR, lewat {id}) dan halaman profil sendiri (employee).
            // Sebelumnya hanya dijaga 'profile-view' sehingga role HR - yang memang
            // tidak punya izin profile-* sama sekali - selalu kena 403 dan terlempar
            // balik ke daftar employee.
            new Middleware(PermissionMiddleware::using(['employee-list|employee-create|employee-edit|employee-delete|profile-view']), only: ['getPerformanceStatistics']),
