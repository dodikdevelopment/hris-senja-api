...
class AttendanceDto
{
    public function __construct(
        ...
        public readonly ?string $check_in_photo = null,
        public readonly ?string $check_out_photo = null,
    ) {}
    ...
    public static function fromArrayForUpdate(array $data, Attendance $existingAttendance): self
    {
        return new self(
            ...
            check_out_photo: $data['check_out_photo'] ?? $existingAttendance->check_out_photo,
        );
    }
}
