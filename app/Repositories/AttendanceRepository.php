...
class AttendanceRepository implements AttendanceRepositoryInterface
{
    ...
    public function checkIn(array $data): Attendance
    {
        return DB::transaction(function () use ($data) {
            ...
            // Foto selfie opsional; disimpan di disk public seperti foto profil/proyek.
            if (isset($data['check_in_photo']) && $data['check_in_photo'] instanceof UploadedFile) {
                $data['check_in_photo'] = $data['check_in_photo']->store('attendance-photos', 'public');
            }
    ...
    public function checkOut(array $data): Attendance
    {
        return DB::transaction(function () use ($data) {
            ...
            if (isset($data['check_out_photo']) && $data['check_out_photo'] instanceof UploadedFile) {
                $data['check_out_photo'] = $data['check_out_photo']->store('attendance-photos', 'public');
            }
