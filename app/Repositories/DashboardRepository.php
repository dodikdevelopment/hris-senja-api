...
class DashboardRepository implements DashboardRepositoryInterface
{
    ...
    public function getEmployeeStatistics(int $employeeId)
    {
        ...
        return cache()->remember($cacheKey, CacheConstants::ONE_HOUR, function () use ($employeeId) {
            ...
            // Total jam kerja bulan ini: hanya hari yang check-in DAN check-out-nya lengkap.
            ...
            $totalHoursWorked = round(((int) ($hoursWorked->total_minutes ?? 0)) / 60, 1);

            // Sisa cuti tahun berjalan: kuota - cuti yang sudah disetujui.
            $leaveQuota = (int) config('hris.annual_leave_quota');
            ...
            $leaveBalance = max(0, $leaveQuota - (int) $usedLeave);
