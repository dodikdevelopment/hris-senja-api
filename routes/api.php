...
Route::prefix('v1')
    ->group(function () {
        ...
        Route::middleware('auth:sanctum')->group(function () {
            ...
            // Komentar task - didaftarkan SEBELUM apiResource supaya
            // 'project-tasks/{task}/comments' tidak tertangkap route show '{project_task}'.
            Route::get('project-tasks/{task}/comments', [TaskCommentController::class, 'index']);
            Route::post('project-tasks/{task}/comments', [TaskCommentController::class, 'store']);
